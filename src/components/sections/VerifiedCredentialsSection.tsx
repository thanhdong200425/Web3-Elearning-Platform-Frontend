...
import VerifiedCredentialCard from "../cards/VerifiedCredentialCard";
...
const VerifiedCredentialsSection: React.FC<VerifiedCredentialsSectionProps> = ({
  credentials,
}) => {
  return (
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="bg-green-100 rounded-lg px-3 py-1">
            <p className="text-xs text-[#008236] font-medium">
              {credentials.length} Certificate
